...
function ExperienceDescription({
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {/* 소개글 */}
      <div>
        <h2 className="text-gray-600 text-body-xl">경험 소개글</h2>
        <p className="text-gray-400 text-caption-md mt-1.5">
          게스트메이트와 함께 먹을 메뉴 등을 써주면 좋아요. (최소 {MIN_LENGTH}자)
        </p>

        <textarea
          className="text-body-lg text-[#878787] pt-2.5 px-4 ring ring-gray-200 rounded-xl w-full mt-3 h-30"
          value={description}
