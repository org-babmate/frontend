...
export function ChatBubble({ content, createdAt, isMe, partnerProfileImage }: ChatBubbleProps) {
  ...
  if (isMe) {
    return (
      <div className="flex flex-col items-end gap-2">
        <div className="max-w-62.5 px-3 py-3 bg-[#4B4B4B] rounded-lg">
  ...
  return (
    <div className="flex flex-row items-start gap-2">
      ...
      <div className="flex flex-col items-start gap-2">
        <div className="max-w-62.5 px-3 py-3 bg-[#F3F3F5] rounded-lg">
