...
export function ChatHeader({ partnerName, partnerProfileImage, onPartnerClick }: ChatHeaderProps) {
  ...
  return (
    <header className="flex flex-row items-center justify-between px-4 py-4 bg-white">
      <div className="flex flex-row items-center gap-3">
        ...
        {/* 상대방 정보 */}
        <button onClick={onPartnerClick} className="flex flex-row items-center gap-3">
          {/* 프로필 이미지 */}
